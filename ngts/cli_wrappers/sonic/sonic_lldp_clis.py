...
class SonicLldpCli(LldpCliCommon):
    ...
    def disable_lldp(engine):
        ...
        :return: command output
        """
        with allure.step('Disable LLDP on {}'.format(engine.ip)):
    ...
    def show_lldp_table(engine):
        ...
        :return: command output
        """
        with allure.step('show lldp table on {}'.format(engine.ip)):
    ...
    def parse_lldp_table_info(engine):
        ...
        """
        with allure.step('parsing LLDP info from show lldp table on {}'.format(engine.ip)):
